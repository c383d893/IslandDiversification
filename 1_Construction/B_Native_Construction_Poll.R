# This script:
# 1. generates counts of native species by pollination syndrome
...
# start from species.dat to include removed data (non poll assignable)
...
saveRDS(dat, "data/native_poll_data_2025.RDS")
